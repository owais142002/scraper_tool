...
def kenyaPropertyCentreDetails():
    ...
    db['kenyapropertycentre.com'][0]=date
    db['kenyapropertycentre.com'][1]=timeStarted
    db['kenyapropertycentre.com'][2]='-'
    db['kenyapropertycentre.com'][3]='-'
    db['kenyapropertycentre.com'][-1]='running'    
    write_db()
    def sendData(data, columns, collectionName):
        try:
            ...
            print('-----------------------------------------')
    def getUrls():
        urls = [f"https://kenyapropertycentre.com/for-rent/short-let?page={i}" for i in range(1, 7)]
        urls += [f"https://kenyapropertycentre.com/for-rent?page={i}" for i in range(1, 100)]
        urls += [f"https://kenyapropertycentre.com/for-sale?page={i}" for i in range(1, 150)]
...
#                 print('')
    ...
    try:
        ...
        db['kenyapropertycentre.com'][2]=timeEnded
        db['kenyapropertycentre.com'][3]=dateEnded
        db['kenyapropertycentre.com'][-1]='completed'
        write_db()
    except Exception as e:
        db['kenyapropertycentre.com'][-1]=f'error occured-->{e}'
        write_db()
